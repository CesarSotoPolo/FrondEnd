...
// a diferencia de otros lenguajes , JS tiene un tipado dinamico
...
console.log("esta lloviendo",typeof estalloviendo);

// tipado dinamico, podemos cambiar el tipo de dato de una variable
let numero=20;
// console.log() puede escribir varios parametros
console.log("Como numero",numero);

numero="veinteeee";
console.log("Como string",numero);

// undefined, aun no esta definido
let regalo;
console.log("tipo de dato relago",regalo);

// null, NO ES primitivo
let nulo=null;
console.log(nulo);
console.log("tipo de dato de null", typeof nulo);

let cantidad="100";
console.log("tipo de dato de cantidad", typeof cantidad);
...
console.log("division:",200/5) ;
console.log("modulo/residuo:",203%5);
