...
btnPassword.addEventListener("click", () => {
   console.log("se cambio el i¿nput del password !!!");
//   alert("Hiciste click!!!!");
// negamos mostrarPassword para evaluar si es false
if(!mostrarPassword){
    inputPassword.setAttribute("type","text");
    mostrarPassword=true;
    //la propiedad innerText es el texto de un elemento
...
piePagina.innerHTML =`<h2 class="titulo-footer">Derechos Reservados 2005</h2>
<p>Soy un parrafo</p>
<p>Soy un parrafo</p>
<p>Soy un parrafo</p>`
