...
const App = () => {
    ...
    //cada vez que haya un cambio de estado (y tambien de props) el compomente se volvera a renderizar
  ...
  return (
    <div>
      ...
      {/* la manera de aumentar events es con elatributo onevento={funcion}*/}
